...
| Item N › Title / Text / Icon | Item 1–8 | Text · Text · Image | 5 item dolu (Technology we own, Hybrid by design, Proven before production, Enterprise-grade, Connected intelligence) | Boş Title = kart gizli. Icon boşsa kartta `01`, `02`… numarası |
